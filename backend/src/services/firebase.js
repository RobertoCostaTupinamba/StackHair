...
module.exports = {
  ...
  uploadToS3: function (imagem, path) {
    return new Promise((resolve, reject) => {
      ...
      stream.on("finish", async () => {
        ...
        //obter a url public
        return resolve({ error: false, message: `https://storage.googleapis.com/${BUCKET}/${path}` });
  ...
  deleteFileS3: function (id) {
    return new Promise((resolve, reject) => {
      ...
      admin.storage().bucket().file(id).delete().catch(err => {
